...
<div class="main-container">
    ...
    <div class="content">
        ...
        <h2 id="totalRevenueDisplay">Total Revenue: 0 VND</h2>
        ...
        <script>
            // Nhận dữ liệu revenue từ server (Java -> JS)
            const revenueData = {
                <% if (revenueData != null) {
            ...
            function updateChart() {
                ...
                Object.entries(revenueData).forEach(([dateStr, revenue]) => {
                    const d = new Date(dateStr);
                    if (isNaN(d.getTime())) return;

                    if (filterType === 'day' && d.toISOString().split('T')[0] === filterDate) {
                        filteredData[dateStr] = revenue;
                ...
                // 👉 Tính tổng doanh thu sau lọc:
                const filteredTotal = Object.values(sortedData).reduce((a, b) => a + b, 0);
                document.getElementById("totalRevenueDisplay").innerText = 
                    "Total Revenue: " + filteredTotal.toLocaleString() + " VND";
            }
        </script>
    </div>
</div>
