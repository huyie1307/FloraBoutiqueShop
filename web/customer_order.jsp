            ...
            <c:if test="${empty orders}">
                <div class="alert alert-warning d-flex align-items-center" role="alert">
                    ...
                    <div>
                        ...
                        <a href="${pageContext.request.contextPath}/listCustomer" class="alert-link">View all customers</a>
                    </div>
                </div>
            </c:if>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${order.orderStatus.statusName eq 'Delivered'}">
                                                                <span class="badge-status status-delivered">
                                                                    <i class="bi bi-check-circle me-1"></i> ${order.orderStatus.statusName}
                                                                </span>
                                                            </c:when>
                                                            <c:when test="${order.orderStatus.statusName eq 'Delivering'}">
                                                                <span class="badge-status status-delivering">
                                                                    <i class="bi bi-truck me-1"></i> ${order.orderStatus.statusName}
                                                                </span>
                                                            </c:when>
                                                            <c:when test="${order.orderStatus.statusName eq 'Confirm Payment'}">
                                                                <span class="badge-status status-confirm">
                                                                    <i class="bi bi-cash-coin me-1"></i> ${order.orderStatus.statusName}
                                                                </span>
                                                            </c:when>
                                                            <c:otherwise>
