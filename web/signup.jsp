                        ...
                        <div class="col-lg-4 col-md-8 col-12 mx-auto">
                            <div class="card z-index-0 fadeIn3 fadeInBottom">
                                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <div class="bg-gradient-dark shadow-dark border-radius-lg py-3 pe-1"style="background: linear-gradient(#FF0080, #FF0080);">
                                ...
                                <div class="card-body">
                                    <form role="form" class="text-start" action="signin" method="POST">
                                        ...
                                        <div class="input-group input-group-outline my-4">
                                            <input type="text" class="form-control" name="name" id="text" placeholder="">
                                            <label for="text" class="form-label">Tên của bạn</label>
                                        </div>
                                        <div class="input-group input-group-outline my-4">
                                    ...
                                    <div class="text-center">
                                        <a href ="Login.jsp" id ="sign" class="btn" style="background-color: #ff69b4; color: white;" class="w-100 my-4 mb-2">Log in</a>
                                    </div>
                                </div>
                            </div>
                        </div>
